    ...
    <div id="wrapper">
        <nav class="navbar navbar-default top-navbar" role="navigation">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="home.php"> <?php echo $_SESSION["a_name"]; ?> </a>
            </div>
									...
									{	
										...
										if($co=="Not Conform")
										{
											echo"<tr>
												...
												<th><a href='roombook.php?uid=".$trow['U_id']." ' class='btn btn-primary'>Action</a></th>
												</tr>";
										}	
